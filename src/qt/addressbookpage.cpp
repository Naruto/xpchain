    ...
    tab(_tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your XPChain addresses for sending payments. Always check the amount and the receiving address before sending coins."));
